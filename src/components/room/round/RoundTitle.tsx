...
import type { RoomRounds, RoundStatus } from '../../../api/types';
...
export function RoundTitle({ roundNumber, rounds, roundStatus }: RoundTitleProps) {
  ...
  return (
    <HStack w="full" justifyContent="center" gap={3}>
      <Text textAlign="center">{roundTitle}</Text>
