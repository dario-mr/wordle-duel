...
import { JoinRoomForm } from '../../../../src/features/rooms/join/JoinRoomForm';
...
vi.mock('../../../../src/features/rooms/join/useJoinRoomAction', () => ({
  useJoinRoomAction: () => ({
...
vi.mock('../../../../src/features/rooms/join/JoinRoomButton', () => ({
  JoinRoomButton: ({
    roomId,
    onJoin,
  }: {
